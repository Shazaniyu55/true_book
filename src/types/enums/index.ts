...
/**
 * Representative HH:mm:ss departure time for each preferred slot. A trip
 * request stores the derived time in `preferredTime` so pool scheduling keeps
 * working unchanged, while the chosen slot is preserved in metadata for display.
 * Morning aligns with the pool default departure time (06:00).
 */
export const PREFERRED_TIME_SLOT_TO_TIME: Record<PreferredTime, string> = {
  [PreferredTime.MORNING]: '06:00:00',
  [PreferredTime.AFTERNOON]: '12:00:00',
  [PreferredTime.EVENING]: '18:00:00',
};
