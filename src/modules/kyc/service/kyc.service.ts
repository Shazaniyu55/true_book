...
async uploadDriverDocument(
  ...
  async finalizeLicenseVerified(driverId: string, entity: Record<string, any>): Promise<void> {
    ...
    await this.notificationService.notify({
      ...
      body: `${driver.user.firstName},Your driver's licence has been verified successfully.`,
  ...
  async finalizeLicenseRejected(driverId: string, reason: string): Promise<void> {
    ...
    await this.notificationService.notify({
      ...
      body: `${driver.user.firstName},We couldn't verify your licence: ${reason}. Please re-upload clear documents.`,
